"""Audit & notifications — Achats & Approvisionnements (Moyens Généraux)."""
...
async def notify_achats_user(
    ...
    *,
    ...
    entity_id=None,
    event_type: str = "achats.workflow",
