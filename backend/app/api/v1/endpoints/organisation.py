...
async def update_agence(entity_id: UUID, payload: AgenceUpdate, db: AsyncSession = Depends(get_db), _: User = Depends(require_permission("immobilisations.update", "immobilisations.create"))):
    try:
...
async def delete_agence(entity_id: UUID, db: AsyncSession = Depends(get_db), _: User = Depends(require_permission("immobilisations.admin"))):
    try:
...
async def list_directions(page: int = Query(1, ge=1), size: int = Query(20, ge=1, le=100), search: str | None = None, _: User = Depends(require_permission("immobilisations.read")), db: AsyncSession = Depends(get_db)):
...
async def create_direction(payload: DirectionCreate, _: User = Depends(require_permission("immobilisations.update", "immobilisations.create")), db: AsyncSession = Depends(get_db)):
    return await DirectionService(db).create(payload)


@router.get("/departements", response_model=PaginatedResponse[DepartementRead])
async def list_departements(page: int = Query(1, ge=1), size: int = Query(20, ge=1, le=100), search: str | None = None, _: User = Depends(require_permission("immobilisations.read")), db: AsyncSession = Depends(get_db)):
...
async def create_departement(payload: DepartementCreate, _: User = Depends(require_permission("immobilisations.update", "immobilisations.create")), db: AsyncSession = Depends(get_db)):
    return await DepartementService(db).create(payload)


@router.get("/centres-cout", response_model=PaginatedResponse[CentreCoutRead])
async def list_centres(page: int = Query(1, ge=1), size: int = Query(20, ge=1, le=100), search: str | None = None, _: User = Depends(require_permission("immobilisations.read")), db: AsyncSession = Depends(get_db)):
...
async def create_centre(payload: CentreCoutCreate, _: User = Depends(require_permission("immobilisations.update", "immobilisations.create")), db: AsyncSession = Depends(get_db)):
    return await CentreCoutService(db).create(payload)


@router.get("/fournisseurs", response_model=PaginatedResponse[FournisseurRead])
async def list_fournisseurs(page: int = Query(1, ge=1), size: int = Query(20, ge=1, le=100), search: str | None = None, _: User = Depends(require_permission("immobilisations.read")), db: AsyncSession = Depends(get_db)):
...
async def create_fournisseur(payload: FournisseurCreate, _: User = Depends(require_permission("immobilisations.update", "immobilisations.create")), db: AsyncSession = Depends(get_db)):
