...
/** Palette BEA (bleus institutionnels) — identique au tableau de bord immo. */
const CHART_COLORS = ['#2874a6', '#3498db', '#1a5278', '#5dade2', '#21618c', '#154360', '#7fb3d5', '#94a3b8'];

@Component({
  selector: 'app-parc-charts-panel',
  imports: [DecimalPipe, MontantPipe, MatIconModule, MatCardModule, MatButtonModule],
  templateUrl: './parc-charts-panel.component.html',
  styleUrl: './parc-charts-panel.component.scss',
})
export class ParcChartsPanelComponent implements OnInit {
  private readonly api = inject(ApiService);

  /** Identifiant SVG unique si le panneau est monté hors du dashboard. */
  @Input() areaFillId = 'vncAreaFill';
